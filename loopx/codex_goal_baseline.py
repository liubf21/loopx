    ...
    *,
    ...
    return {
        ...
        "claim_boundary": {
            ...
            "must_not_include_loopx_state": True,
        },
    }
...
def build_codex_app_server_goal_baseline_proof(
    *,
    ...
    included_loopx_state: bool = False,
    ...
    return {
        ...
        "negative_controls": {
            ...
            "included_loopx_state": bool(included_loopx_state),
        },
        "read_boundary": {
...
def build_codex_app_server_goal_worker_proof(
    *,
    ...
    baseline = build_codex_app_server_goal_baseline_proof(
        ...
        included_loopx_state=included_loopx_state,
...
def run_isolated_codex_app_server_goal_probe(
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="loopx-codex-goal-") as tmp:
        root = Path(tmp)
        home = root / "home"
