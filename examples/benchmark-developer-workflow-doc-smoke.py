...
def main() -> int:
    ...
    require(
        ...
        [
            ...
            "former prompt-polling controller is retired",
            "historical_nonproduct_invalid_for_comparison",
            "not LoopX product behavior",
            "packet-only route diagnostics",
            "do not have a countable LoopX treatment arm",
            "loopx-goal-start-product-mode",
            "guided `/loopx` goal-start surface",
            "agent-authored plan before todo writes",
            "Terminal-Bench does not currently ship a comparable LoopX",
            "SWE-Marathon",
            "not yet shipped",
            "real case-local LoopX product lifecycle",
