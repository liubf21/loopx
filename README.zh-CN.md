...
- 快速交流、使用反馈、onboarding 与贡献协作：请加入飞书开发群。二维码永久
  有效；若入口异常，请提 Issue 提醒维护者。
...
[控制面开发者 8 讲](docs/development/control-plane-course/README.md)开始，按真实 CLI
执行路径、状态机、核心函数和 smoke 建立代码心智模型。
