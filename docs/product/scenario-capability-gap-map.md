...
| P1 | Research and material registry loops | `docs/operations/authority-source-registration.md`, `docs/research/` | `authority_source_v0`, compact source contracts, and freshness checks so durable materials can guide routing without copying source bodies or private links. |
