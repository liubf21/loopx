...
includes(readFileSync("../../examples/status.example.json", "utf8"), '"todo_index"', "example todo index projection");
includes(readFileSync("../../examples/status.example.json", "utf8"), '"handoff_note": {', "example handoff note projection");
includes(readFileSync("../../examples/status.example.json", "utf8"), '"schema_version": "handoff_note_v0"', "example typed handoff note version");
includes(readFileSync("../../examples/status.example.json", "utf8"), '"claimed_by": "codex-value-explorer"', "example claimed agent row");
