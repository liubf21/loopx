...
DEFAULT_BUILD_STALL_TIMEOUT_SEC = 3600
DEFAULT_LOOPX_TURN_TERMINAL_FAILURE_GRACE_SEC = 30
LOOPX_TURN_TERMINAL_FAILURE_POLL_SEC = 1.0
...
HISTORICAL_REDUCER_ROUTES = tuple(
    sorted(LEGACY_NONPRODUCT_PROMPT_POLLING_ROUTES)
)
DEFAULT_ROUTE = CODEX_CLI_GOAL_BASELINE_ROUTE
...
LOOPX_CASE_RUNTIME_ROUTES = frozenset(
    {
...
HOST_LOCAL_BRIDGE_ROUTES = frozenset(
    {
        *PRODUCT_MODE_CONTROLLER_ROUTES,
        LOOPX_TURN_AGENT_CLI_ROUTE,
    }
)
