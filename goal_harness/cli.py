        ...
        if args.benchmark_command == "agentissue-codex-runner-flow":
            ...
            try:
                ...
                if len(selected_roots) > 1:
                    raise ValueError(
                        "agentissue-codex-runner-flow accepts at most one root option, not both: --synthetic-staging-root, --execution-gate-root, --first-run-handoff-root, --real-result-root, or --private-runner-root"
                    )
